...
RISK_SIGNALS: dict[str, tuple[str, ...]] = {
    # 지침·규칙 '변경' — 반드시 승인. 주의: 부분문자열 매칭이라 '지침' 단독은 '미리보기 지침에 맞춰 제출'처럼
    # 지침을 *따르는* 양성 표현까지 오탐한다(라이브에서 결재 게이트 오발동). 변경 의도(수정/편집/바꾸/추가)나
    # 실제 지침 파일(law.md 등) 대상일 때만 잡는다.
    "guide_change": (
        "law.md", "law_", "role.md", "claude.md", "agents.md", "gemini.md", "gemma.md",
        "정책 변경", "정책변경", "규칙 변경", "규칙변경",
        "지침 변경", "지침변경", "지침 수정", "지침 편집", "지침 추가", "지침 개정",
        "지침을 바꾸", "지침을 바꾼", "지침 바꾸", "지침을 고치", "지침을 고친",
        "공간지침 변경", "공간지침 수정", "공간지침 편집", "공간지침을 바꾸", "공간지침을 바꾼", "공간지침을 고치", "공간지침을 고친",
    ),
    # 대외비 공유/반출 — 반드시 승인
    "confidential_share": (
